      ...
      <aside id="col2">
        ...
        <section class="card" style="margin-bottom:12px">
          ...
          <div class="card-body">
            ...
            <p style="margin-top:12px">UYAP'tan <strong>Kesinleşme Zamanı Gelen Dosyalar</strong> raporunu EXCEL formatında alıp buradan yükleyiniz.</p>
          </div>
        </section>
...
<script src="/assets/js/kesinlesme-kontrol.js?v=2"></script>
