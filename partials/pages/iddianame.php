...
<main class="flex-grow-1 overflow-auto">
	<div class="container-fluid py-4">
		...
		<div class="d-flex justify-content-between align-items-center mb-4">
			<div>
				<h2 class="mb-1">İddianame Değerlendirme Zaman Kontrolü</h2>
		...
		<div class="row">
			...
			<div class="col-12 col-xl-4">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<p class="mb-0">Tarafınıza gönderilen <strong>İddianame Değerlendirme Zaman Kontrolü</strong> dosyasını yükleyerek işleyebilir ve denetim cetveli olarak teslim edebiliriz.</p>
					</div>
				</div>
		...
		<script defer src="/assets/js/iddianame.js?v=3&t=<?php echo time(); ?>"></script>
	</div>
</main>